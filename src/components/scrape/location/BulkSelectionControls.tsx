      ...
      <>
        ...
        <div className="relative">
          ...
          <Input
            ...
            disabled={isProcessing || disabled} // Add disabled prop
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="relative" ref={dropdownRef}>
            <Button 
              ...
              disabled={isProcessing || disabled} // Add disabled prop
              onClick={() => !disabled && setIsOpen(!isOpen)} // Disable click when disabled
            >
              Bulk Actions
                  ...
                  <div className="p-1">
                    {bulkActions.map((action, index) => (
                      <React.Fragment key={action.id}>
                        ...
                        <button
                          onClick={() => !disabled && handleBulkAction(action)} // Disable click when disabled
                          className={cn(
                            "w-full flex items-center justify-between py-2.5 px-3 cursor-pointer hover:bg-muted rounded-md transition-colors",
